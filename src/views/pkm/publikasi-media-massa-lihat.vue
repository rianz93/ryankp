<template>
	<div>
		<div class="container">
			<div class="row">
				<div class="col">
					<h3>Publikasi Media Massa</h3>
					<p>Kelola data publikasi media massa.</p>
				</div>
				<div class="col mt-3"">
					<div class="row">
...
export default {
	data() {
		return {
			...
			tableContent: {
				namaTable: "publikasi_media_massa",
				namaId: "publikasi_media_massa_id",
				componentName: "publikasi-media-massa-tambah",
			},
		};
	},
	components:{
	...
	methods: {
		getData() {
			var app = this;
			axios
				.get(API_ENDPOINT + "/pkm/getMedia.php")
		...
		filteredTahun(value){ 
			if(value == null){ 
				...
				return value.filter(data=>{ let datas =	data[2].title.toLowerCase().includes(this.filterJudul); return datas; }); 
			} 
		}
