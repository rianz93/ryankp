...
export default {
	data() {
		return {
			...
			tableContent: {
				namaTable: "produk_tersertifikasi",
				namaId: "produk_tersertifikasi_id",
				componentName: "produk-tersertifikasi-tambah",
			},
		};
	},
	components:{
	...
	methods: {
		getData() {
			...
			axios
				.get(API_ENDPOINT + "/pkm/getProdukTersertifikasi.php" + idParam)
